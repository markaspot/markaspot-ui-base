/**
 * Server-side color resolution for Nitro routes.
 *
 * Nitro cannot import from app/ (client-side code), so this provides
 * a minimal copy of the Tailwind color map + resolveColorToHex().
 * The canonical map lives in app/utils/colorPalette.ts.
 */
