<template>
  ...
  >
    <fieldset :disabled="loading">
      ...
      >
        <p v-if="loading">
          {{ loadingMessage || 'Form is processing. Please wait.' }}
        </p>
        <p v-if="success">
...
// Announce to screen readers by updating the ARIA live region
